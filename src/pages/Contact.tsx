...
const Contact = () => {
  ...
  const contactInfo = [
    { icon: MapPin, title: "Adresse", details: ["Kebdana, Nador", "Maroc"], color: "from-primary to-quad" },
    { icon: Phone, title: "Téléphone", details: ["+212 600 000 000", "+212 600 000 001"], color: "from-quad to-cross" },
    { icon: Mail, title: "Email", details: ["info@redroadsadventure.com", "booking@redroadsadventure.com"], color: "from-cross to-primary" },
    { icon: Clock, title: "Horaires", details: ["Lun - Dim : 8h00 - 19h00", "Réservations 24h/24"], color: "from-primary to-cross" },
  ];
            ...
            {contactInfo.map((info, index) => (
              ...
              >
                ...
                {info.details.map((detail) => (
                  <p key={detail} className="font-body text-sm text-muted-foreground">{detail}</p>
                ))}
              </motion.div>
            ))}
          </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    placeholder="Parlez-nous de vos projets d'aventure... Quel type de balade vous intéresse ? Combien de personnes ?" 
                    rows={6} 
                    required 

...
const values = [{
  icon: Target,
  title: "Notre Mission",
  description: "Offrir des aventures tout-terrain inoubliables tout en mettant en valeur la beauté naturelle des paysages marocains."
}, {
  icon: Heart,
  title: "Notre Passion",
  description: "Nous vivons pour le frisson de la conduite et partageons cette passion avec chaque invité qui nous rejoint sur les pistes."
}, {
  icon: Users,
  title: "Notre Communauté",
  description: "Construire une famille de passionnés d'aventure qui partagent notre amour pour l'exploration et le plein air."
}, {
  icon: Award,
  title: "Notre Promesse",
  description: "La sécurité, la qualité et des expériences exceptionnelles sont au cœur de tout ce que nous faisons."
}];
const About = () => {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            once: true
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-adventure">
                <img src={nature1} alt="Nos pistes" className="w-full h-[500px] object-cover" />
              ...
              <div className="absolute -bottom-8 -left-8 w-56 h-56 rounded-2xl overflow-hidden border-4 border-background shadow-2xl">
                <img src={nature2} alt="Aventure" className="w-full h-full object-cover" />
              </div>
              <div className="absolute -top-6 -right-6 w-32 h-32 rounded-2xl overflow-hidden border-4 border-background shadow-xl">
                <img src={nature3} alt="Kebdana" className="w-full h-full object-cover" />
              </div>
            </motion.div>
          </div>
        </div>
